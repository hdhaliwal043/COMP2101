...
###############
title="Overlord"
#assigning the name to variable
USER=Harinder
...
# Main        #
###############
#assigning the output value to a variable instead of displaying
login="Welcome to planet $hostname, $title $USER! It is $day at $time"
#using cowsay command to display stored value in variable
cowsay $login
